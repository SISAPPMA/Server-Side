...
router.post(
    "/add-admin", 
    checkAuthMiddleware.checkAuth('admin'), 
    adminController.addAdmin);
router.patch(
    "/edit-admin/:id", checkAuthMiddleware.checkAuth('admin'), 
    adminController.editAdmin
);
router.patch(
    "/edit-admin/:id/edit-foto-profil", checkAuthMiddleware.checkAuth('admin'), 
    imageUploader.upload.single('image'), 
    adminController.editFotoProfil
);
router.patch(
    "/edit-admin/:id/delete-foto-profil", checkAuthMiddleware.checkAuth('admin'), 
    adminController.deleteFotoProfil
);
